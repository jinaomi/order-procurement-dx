...
namespace CaseMngmt.Service.PurchaseInvoices
{
    public interface IPurchaseInvoiceService
    {
        ...
        Task<PagedResult<PurchaseInvoiceViewModel>?> GetAllAsync(Guid companyId, Guid? supplierId, string? status, string? purchaseInvoiceNumber, DateTime? issueDateFrom, DateTime? issueDateTo, int pageSize, int pageNumber);
