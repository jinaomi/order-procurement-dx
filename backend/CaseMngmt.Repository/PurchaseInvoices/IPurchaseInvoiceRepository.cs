...
namespace CaseMngmt.Repository.PurchaseInvoices
{
    public interface IPurchaseInvoiceRepository
    {
        ...
        Task<PagedResult<PurchaseInvoice>?> GetAllAsync(Guid companyId, Guid? supplierId, string? status, DateTime? issueDateFrom, DateTime? issueDateTo, int pageSize, int pageNumber);
